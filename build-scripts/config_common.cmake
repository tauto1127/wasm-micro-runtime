...
# C/Rサポートビルド
if (NOT DEFINED WAMR_BUILD_CR)
  set (WAMR_BUILD_CR 0)
endif()
if (WAMR_BUILD_CR EQUAL 1)
  add_definitions (-DWASM_ENABLE_CR=1)
  message ("     Checkpoint/Restore support enabled")
else ()
  add_definitions (-DWASM_ENABLE_CR=0)
endif ()