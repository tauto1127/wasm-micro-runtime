...
static inline uint32 wasm_type_width(uint8 type) {
    switch (type) {
        case VALUE_TYPE_I32:
        case VALUE_TYPE_F32: return 1;
        case VALUE_TYPE_I64:
        case VALUE_TYPE_F64: return 2;
        default:
            wasmig_error("unknown type");
            return 4;
    }
}
    ...
    while (p < p_end) {
        ...
        switch (opcode) {
            ...
            handle_op_block_and_loop:
            {
                ...
                // Push label stack for restoring
